...
<div class="editor" style="background-image: url(editor/bg.gif); background-repeat: repeat-x;">
	<div class="editorbutton" OnClick="RowsTextarea('area',1)"><img title="��������� ����" src="editor/plus.gif"></div>
	<div class="editorbutton" OnClick="RowsTextarea('area',0)"><img title="��������� ����" src="editor/minus.gif"></div>
	...
	<div class="editorbutton" OnClick="InsertCode('u')"><img title="������������ �����" src="editor/underline.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('s')"><img title="������������� �����" src="editor/striket.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('li')"><img title="������������� ������" src="editor/li.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('hr')"><img title="�������������� �����" src="editor/hr.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('left')"><img title="������������ �� ������ ����" src="editor/left.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('center')"><img title="������������ �� ������" src="editor/center.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('right')"><img title="������������ �� ������� ����" src="editor/right.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('justify')"><img title="������������ �� ������" src="editor/justify.gif"></div>
	...
	<div class="editorbutton" OnClick="InsertCode('url','������� ������ �����','������� ��������','�� �� ������� �����!')"><img title="�������� ������" src="editor/url.gif"></div>
	<div class="editorbutton" OnClick="InsertCode('mail','������� ������ �����','������� ��������','�� �� ������� �����!')"><img title="�������� E-Mail" src="editor/mail.gif"></div>
...
<div class="editor" style="background-image: url(editor/bg.gif); background-repeat: repeat-x;">
	...
	<div class="editorbutton" OnClick="translateAlltoCyrillic()"><img title="������� ������ � �������� � ���������" src="editor/rus.gif"></div>
	<div class="editorbutton" OnClick="translateAlltoLatin()"><img title="������� ������ � ��������� � ��������" src="editor/eng.gif"></div>
	<div class="editorbutton" OnClick="changelanguage()"><img title="�������������� ������� ������" src="editor/auto.gif"></div>
	...
	<div class="editorbutton"><select class="editorinput" tabindex="1" style="font-size:10px;" name="family" onChange="InsertCode('family',this.options[this.selectedIndex].value)" onFocus="this.value='�����'"><option style="font-weight:bold;" value="�����">�����</option><option style="font-family:Verdana;" value="Verdana">Verdana</option><option style="font-family:Arial;" value="Arial">Arial</option><option style="font-family:'Courier New';" value="Courier New">Courier New</option><option style="font-family:Tahoma;" value="Tahoma">Tahoma</option><option style="font-family:Helvetica;" value="Helvetica">Helvetica</option></select></div>
	...
	<div class="editorbutton"><select class="editorinput" tabindex="1" style="font-size:10px;" name="size" onChange="InsertCode('size',this.options[this.selectedIndex].value)" onFocus="this.value='������'"><option style="font-weight:bold;" value="������">������</option><option value="8">������ 8</option><option value="10">������ 10</option><option value="12">������ 12</option><option value="14">������ 14</option><option value="18">������ 18</option><option value="24">������ 24</option></select></div>
</div>
<?php
}

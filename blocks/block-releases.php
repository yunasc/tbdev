...
if (!$count) {
	...
	while ($release = mysql_fetch_array($res)) {
		...
		$content .= "<td><div align=\"left\">".(!empty($catname) ? "<a href=\"browse.php?cat=$catid\"><img src=\"pic/cats/$catimage\" alt=\"$catname\" title=\"$catname\" align=\"right\" border=\"0\" /></a>" : "").format_comment($release["top"])."<br /></div><div align=\"left\"><hr align=\"left\" width=\"85%\" color=\"#000000\" size=\"1\"></div><div align=\"left\">".format_comment($release["center"])."<br /></div><div align=\"left\"><hr align=\"left\" width=\"85%\" color=\"#000000\" size=\"1\"></div><div align=\"left\">".format_comment($release["bottom"])."</div><div align=\"right\">".($release["imdb"] ? "[<a href=\"$release[imdb]\" class=\"online\">IMDB</a>] " : "")."[<a href=\"details.php?id=$release[torrentid]\" alt=\"$release[name]\" title=\"$release[name]\"><b>Детали</b></a>]</div></td>";
		$content .= "</tr>";
		$content .= "</table>";
		$content .= "</td></tr>";
	}

...
class lang implements arrayaccess {
	...
	public function __construct() {
		$this->tlr = array(
			...
			'golden_descr' => 'Золотой торрент (считаеться только раздача, закачка не учитывается)',
			...
			'mark_as_read' => 'Отметить выделеные сообщения как прочитаные',
			'mark_read' => 'Прочитать',
			'max_avatar_size' => 'Размеры аватарки должны быть не более %dx%d пикселей.',
			'max_file_size' => 'Максимальный размер файла',
			'messages' => 'Сообщения',
			'missing_form_data' => 'Заполите все поля формы.',
			...
			'no_online_users' => 'Небыло активных пользователей за последние 15 минут.',
			...
			'taken_from_torrent' => 'Берется из торрента. <b>Пожалуста, используйте понятные имена.</b>',
			'thanks' => 'Спасибо',
